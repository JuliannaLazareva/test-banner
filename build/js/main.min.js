...
var _navMobile = require("./modules/nav-mobile");
var _languageToggle = require("./modules/language-toggle");
var _bannerSlider = require("./modules/banner-slider");
var _blogSlider = require("./modules/blog-slider");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  (0, _navMobile.initNavMobile)();
  (0, _languageToggle.initlanguageButton)();
  (0, _bannerSlider.initBannerSlider)();
  (0, _blogSlider.initBlogSlider)();
...
},{"./modules/banner-slider":2,"./modules/blog-slider":3,"./modules/form-validate/form":5,"./modules/language-toggle":11,"./modules/modals/init-modals":12,"./modules/nav-mobile":14,"./utils/ios-vh-fix":17}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initBannerSlider = initBannerSlider;
var mql = window.matchMedia('(max-width: 1023px)');
var bannerSliderElement = document.querySelectorAll('.slider__container');
// const bannerSliderReverseElement = document.querySelectorAll('.slider__container-reverse');

function initBannerSlider() {
  bannerSliderElement.forEach(function (element, index) {
    var autoplay = {
    ...
    var loop = true;
    var bunnerSlider = new window.Swiper(element, {
...
exports.initBlogSlider = initBlogSlider;
var blogSliderElement = document.querySelector('.blog__container');
function initBlogSlider() {
  var bunnerSlider = new window.Swiper(blogSliderElement, {
    breakpoints: {
      1024: {
        slidesPerView: 'auto',
        spaceBetween: 16
...
exports.initlanguageButton = void 0;
// let page = document.querySelector('.page');
var languageButton = document.querySelector('.page-header__language-button');
var initlanguageButton = exports.initlanguageButton = languageButton.onclick = function () {
  ...
  // page.classList.toggle('language-en');
  // page.classList.toggle('language-ru');
  if (window.innerWidth > '767') {
    languageButton.innerHTML = languageButton.innerHTML === 'en' ? languageButton.innerHTML = 'ru' : languageButton.innerHTML = 'en';
  } else {
...
exports.initNavMobile = initNavMobile;
